...
class Membresia_model extends CI_Model {
    ...
    public function obtener_membresias_periodo($usuario_id, $periodo)
    {
        $this->db->select('gimnasio_usuarios_membresia.id,
            ...
            DATE_ADD(gimnasio_usuarios_membresia.fecha_inicio, INTERVAL gimnasio_planes.periodo MONTH) as fecha_vencimiento,
        ...
        $this->db->where('DATE_FORMAT(gimnasio_usuarios_membresia.fecha_inicio, "%Y") =', $periodo);
        // $this->db->limit(1);
